...
/* NOTE: This file incorporates additional changes to the original from https://github.com/nvidoni/fancybox */
...
;(function($) {
	var tmp, loading, overlay, wrap, outer, content, close, title, nav_left, nav_right,
		...
		ajaxLoader = null, imgPreloader = new Image(), imgRegExp = /\.(jpe?g|gif|png|bmp|webp)(.*)?$/i, swfRegExp = /[^\.]\.(swf)\s*$/i,
		...
		*/
		...
		_get_viewport = function() {
			...
			var device = {
				iphone: /i(Phone|Pod|Pad)/.test(ua),
