...
class SigPlusNovoFileSystemException extends SigPlusNovoException {
	...
	public function __construct($key, $path) {
		$this->path = self::makeRelative($path);
		parent::__construct($key);
	}
}
...
/**
* Triggered when the feed source specified for a gallery is not valid.
*/
...
/**
* Triggered when an XML feed is ill-formed, missing mandatory elements or attributes, or contains invalid data.
*/
class SigPlusNovoXMLFeedException extends SigPlusNovoException {
	protected $url;

	public function __construct($url) {
		$this->url = $url;
		parent::__construct('SIGPLUS_EXCEPTION_FEED_XML');
	}
}
